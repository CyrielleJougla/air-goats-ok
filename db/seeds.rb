...
goat7 = Goat.create!(name:"Maximator", price: 10, age: 6, race: "alpine", appetite: "level expert: dévoreuse de prés", bonus: "fait aussi chien de garde", description:"Maximator n'est pas une chèvre comme les autres. Issue d'une croisement entre une chèvre alpine et un ours polaire, elle ne fera qu'une bouchée de vos terrains les plus grands, ainsi que de vos ennemis", picture:"https://res.cloudinary.com/drnblm552/image/upload/v1606477730/maxx_dfjuvt.jpg", user: user1)
